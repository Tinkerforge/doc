...
html:
	...
	@echo
	@echo "Changing Source_Code.html from doc to bugs"
	sed -e "s|'doc'|'bugs'|" build/html/Source_Code.html > build/html/Source_Code.htmltmp
	mv build/html/Source_Code.htmltmp build/html/Source_Code.html
