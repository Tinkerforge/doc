...
class CSharpObject(ObjectDescription):
    """Description of a CSharp language object."""
    ...
    def attach_type(self, node, type):
        ...
        pnode['csharp:parent'] = self.env.temp_data.get('csharp:parent')
...
#        if obj.visibility != 'public':
    ...
    def add_target_and_index(self, sigobj, sig, signode):
        ...
        self.env.domaindata['csharp']['objects'].setdefault(name,
    ...
    def before_content(self):
        ...
        if lastname and not self.env.temp_data.get('csharp:parent'):
            ...
            self.env.temp_data['csharp:parent'] = lastname.name
    ...
    def handle_signature(self, sig, signode):
        ...
        parent = self.env.temp_data.get('csharp:parent')
...
class CSharpFunctionObject(CSharpObject):
    ...
    def get_index_text(self, name):
        return _('%s (CSharp function)') % name
...
class CSharpCurrentNamespace(Directive):
    ...
    def run(self):
        ...
        if self.arguments[0].strip() in ('NULL', '0', 'nullptr'):
            env.temp_data['csharp:prefix'] = None
        else:
            ...
            try:
                ...
                env.temp_data['csharp:prefix'] = prefix
        return []
...
class CSharpDomain(Domain):
    ...
    roles = {
        ...
        'func' :  CSharpXRefRole(fix_parens=True),
