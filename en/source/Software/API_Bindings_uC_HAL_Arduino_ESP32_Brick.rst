...
C/C++ for Microcontrollers - Arduino ESP32 Brick HAL
====================================================

The Arduino ESP32 Brick Hardware Abstraction Layer (HAL) is used
...
This HAL is designed to be used with the :ref:`ESP32 Brick <esp32_brick>` only and
...
* example_driver/
  ...
  * example_driver.ino [from the hal_arduino_esp32_brick folder]
  ...
  * src/
    ...
    * hal_arduino_esp32_brick/
      ...
      * [copy hal_arduino_esp32_brick.cpp and hal_arduino_esp32_brick.h here]
...
Now connect the ESP32 Brick to USB then build and upload the sketch. The prints
