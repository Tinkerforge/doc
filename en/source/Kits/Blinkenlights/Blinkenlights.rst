...
* :ref:`Demo Application <starter_kit_blinkenlights_demo_examples>` (Download: `Windows <https://download.tinkerforge.com/kits/blinkenlights/windows/starter_kit_blinkenlights_demo_windows_latest.exe>`__, `Linux <https://download.tinkerforge.com/kits/blinkenlights/linux/starter-kit-blinkenlights-demo-linux_latest.deb>`__, `macOS <https://download.tinkerforge.com/kits/blinkenlights/macos/starter_kit_blinkenlights_demo_macos_latest.dmg>`__, `Source Code <https://github.com/Tinkerforge/blinkenlights/tree/master/demo>`__)
