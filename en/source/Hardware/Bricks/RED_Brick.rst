...
* 3D model (`View online <http://a360.co/2vPoEbK>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/red/red.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricks/red/red.FCStd>`__)
...
is activated and you have connected the `3G USB Adapter
<https://www.tinkerforge.com/en/shop/accessories/red-brick/3g-usb-adapter.html>`__
to the RED Brick USB port.
