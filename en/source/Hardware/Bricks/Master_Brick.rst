...
* 3D model(`Download STEP <http://download.tinkerforge.com/3d/bricks/master/master.step>`__ | `Download FreeCAD <http://download.tinkerforge.com/3d/bricks/master/master.FCStd>`__)
