...
* 3D model (`View online <http://autode.sk/2gC31Jn>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/master/master.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricks/master/master.FCStd>`__)
