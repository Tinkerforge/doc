...
* 3D model (Download: `STEP <http://download.tinkerforge.com/3d/power_supplies/step_down/step-down.step>`__, `FreeCAD <http://download.tinkerforge.com/power_supplies/step_down/step-down.FCStd>`__)
