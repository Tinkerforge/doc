...
* 3D model (`View online <https://autode.sk/2BVUBBy>`__ | Download: `STEP <https://download.tinkerforge.com/3d/power_supplies/step_down/step-down.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/power_supplies/step_down/step-down.FCStd>`__)
