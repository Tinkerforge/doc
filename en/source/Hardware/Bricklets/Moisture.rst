...
* 3D model (`View online <http://autode.sk/2xfSGpz>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/moisture/moisture.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/moisture/moisture.FCStd>`__)
