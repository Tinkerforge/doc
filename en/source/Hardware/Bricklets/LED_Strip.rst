...
* 3D model (`View online <http://a360.co/2vsuqCo>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/led_strip/led_strip.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/led_strip/led_strip.FCStd>`__)
