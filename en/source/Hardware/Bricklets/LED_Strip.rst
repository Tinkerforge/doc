...
.. raw:: html
	...
	Cases/bricklet_led_strip_case_tilted_[?|?].jpg          LED Strip Bricklet in Case
	Bricklets/bricklet_led_strip_50_pixel_[100|600].jpg     LED Strip Bricklet with 50 RGB LED Pixels
	Bricklets/bricklet_led_strip_w_reel_[100|600].jpg       LED Strip Bricklet with RGB LED Strip
	Bricklets/bricklet_led_strip_brickv_[100|].jpg          LED Strip Bricklet in Brick Viewer
	Dimensions/led_strip_bricklet_dimensions_[100|600].png  Outline and drilling plan
...
* Controls up to 320 RGB or 240 RGBW LEDs
...
It is possible to independently control 320 RGB or 240 RGBW LEDs (960 individual LEDs) over
...
Maximum Number of LEDs            960 (320 RGB or 240 RGBW LEDs)*
...
* 3D model (`View online <https://autode.sk/2BfXSyW>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/led_strip/led-strip.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/led_strip/led-strip.FCStd>`__)
...
or 60 RGBW LEDs with the RAM that is available per Bricklet.
...
320 RGB or 240 RGBW LEDs with one Master Brick and one LED Strip Bricklet. As described above
these used ports can't be used by other Bricklets.

The maximum number of controllable LEDs is as follows:

================================  ==================================  ==================================
Free Bricklet Ports               Maximum number of RGB LEDs          Maximum number of RGBW LEDs
================================  ==================================  ==================================
0                                 80                                  60
1                                 160                                 120
2                                 240                                 180
