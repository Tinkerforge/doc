...
* 3D model (`View online <https://autode.sk/2v9CCqr>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/temperature_v2/temperature-v2.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/temperature_v2/temperature-v2.FCStd>`__)
