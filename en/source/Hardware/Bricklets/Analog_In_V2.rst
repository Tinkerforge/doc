...
.. note::
 ...
 The Analog In Bricklet 2.0 is discontinued and is no longer sold. The
...
* 3D model (`View online <https://autode.sk/2BgJkyQ>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/analog_in_v2/analog-in-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/analog_in_v2/analog-in-v2.FCStd>`__)
