...
* 3D model (`View online <http://autode.sk/2gCq3Qq>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/analog_in_v2/analog_in.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/analog_in_v2/analog_in.FCStd>`__)
