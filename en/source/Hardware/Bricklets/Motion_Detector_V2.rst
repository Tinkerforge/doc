...
.. raw:: html
	...
	Cases/bricklet_motion_detector_v2_case_be_built_up_[?|?].jpg      Motion Detector Bricklet 2.0 in case (black)
...
* 3D model (`View online <https://autode.sk/2sBeApm>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/motion_detector_v2/motion-detector-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/motion_detector_v2/motion-detector-v2.FCStd>`__)
