...
.. raw:: html
 ...
 The Temperature IR Bricklet is discontinued and is no longer sold. The
 :ref:`Temperature IR Bricklet 2.0 <temperature_ir_v2_bricklet>` is the recommended
 replacement.
...
* 3D model (`View online <https://autode.sk/2BcGJWF>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/temperature_ir/temperature-ir.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/temperature_ir/temperature-ir.FCStd>`__)
