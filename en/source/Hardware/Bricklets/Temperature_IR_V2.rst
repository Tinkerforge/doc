...
* Schematic (`Download <https://github.com/Tinkerforge/temperature-ir-v2-bricklet/raw/master/hardware/temperature-ir-schematic.pdf>`__)
...
* 3D model (`View online <http://autode.sk/2Euzglf>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/temperature_ir_v2/temperature_ir.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/temperature_ir_v2/temperature_ir.FCStd>`__)
