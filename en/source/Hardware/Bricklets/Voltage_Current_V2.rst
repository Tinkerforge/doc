...
* 3D model (`View online <https://autode.sk/2KdgYGx>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/voltage_current_v2/voltage-current-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/voltage_current_v2/voltage-current-v2.FCStd>`__)
