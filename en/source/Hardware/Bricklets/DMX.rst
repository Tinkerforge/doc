...
* 3D model (`View online <http://autode.sk/2yJPLu6>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/dmx/dmx-bricklet.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/dmx/dmx-bricklet.FCStd>`__)
