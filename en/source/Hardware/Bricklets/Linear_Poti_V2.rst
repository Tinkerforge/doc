...
The Linear Poti Bricklet 2.0 has a 7 pole Bricklet connector and is connected to a
...
* 3D model (`View online <https://autode.sk/2JFwmP6>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/linear_poti_v2/linear-poti-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/linear_poti_v2/linear-poti-v2.FCStd>`__)
