...
* 3D model (`View online <https://autode.sk/2JFwmP6>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/linear-poti-v2.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/linear-poti-v2.FCStd>`__)
