...
* 3D model (`View online <https://autode.sk/2GdSuyv>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/accelerometer_v2/accelerometer-v2.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/accelerometer_v2/accelerometer-v2.FCStd>`__)
