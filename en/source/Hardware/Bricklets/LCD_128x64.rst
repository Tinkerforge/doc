...
* Automatic touch gesture recognition (swipe left/right etc)
...
of 128x64 pixel and touchscreen.
...
display. The screen size is very similar to the screen size of the
old LCD 20x4 Bricklet, so it can be used as a replacement.
...
If you press with your finger or a stick on the display you can
a red circile at the press-position in Brick Viewer. The number
of circiles corresponds to the touch pressure.
...
We provide examples for (TODO: FIXME)
...
with a little bit more pressure then you are used to with your phone, but you can 
also use a stick or similar instead of your finger.

With the API you can get the currently pressed coordinate (x, y) as well as the
touch pressure. You can use this for detection of "clicks" or gestures.

Some gestures (swipe left, right, down, up with the start- and end-position of 
