...
* 3D model (`View online <https://autode.sk/2nJnz25>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/solid_state_relay_v2/solid-state-relay-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/solid_state_relay_v2/solid-state-relay-v2.FCStd>`__)
