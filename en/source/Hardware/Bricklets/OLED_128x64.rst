...
* 3D model (`View online <http://autode.sk/2hEabJM>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/oled_128x64/oled-128x64.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/oled_128x64/oled-128x64.FCStd>`__)
