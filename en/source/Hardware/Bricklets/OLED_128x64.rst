...
and flash (4 KByte) available. This is not enough to for example cache a 
...
* C# (with TODO), 
* Java (with TODO) and 
* `Python <https://raw.githubusercontent.com/Tinkerforge/oled-128x64-bricklet/master/software/examples/python/example_draw_servo_poti.py>`__ (with `PIL <https://python-pillow.github.io/>`__).
