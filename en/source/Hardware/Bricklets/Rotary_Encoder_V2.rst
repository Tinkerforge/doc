...
* 3D model (`View online <https://autode.sk/2EHoGaC>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/rotary_encoder_v2/rotary-encoder-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/rotary_encoder_v2/rotary-encoder-v2.FCStd>`__)
