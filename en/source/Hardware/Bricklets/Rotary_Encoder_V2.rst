...
* 3D model (`View online <http://autode.sk/2EHoGaC>`__ | Download: `STEP <http://download.tinkerforge.com/3d/rotary_encoder_v2/rotary_encoder.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/rotary_encoder_v2/rotary_encoder.FCStd>`__)
