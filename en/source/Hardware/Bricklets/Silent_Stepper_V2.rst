...
* Two configurable GPIOs for end-stops or similar
...
With the Silent Stepper :ref:`Bricklet <primer_bricklets>` 2.0 one bipolar
...
can be controlled.  With the provided API for many 
...
The stepper motor is powered by an external power supply connected
directly to the Bricklet (black connector).

It is possible to run the Silent Stepper Bricklet 2.0 in a variety of different modes.
...
(Classic mode). The Silent Stepper Bricklet 2.0 can be configured to switch between 
...
The following picture shows the different connection possibilities of the
Silent Stepper Bricklet 2.0.

.. image:: /Images/Bricklets/bricklet_silent_stepper_v2_caption_600.jpg
   :scale: 100 %
   :alt: Silent Stepper Bricklet 2.0 with caption
   :align: center
...
Test your Silent Stepper Bricklet 2.0
-------------------------------------
...
If an over-temperature or short to ground event occurs the motor
...
`TMC2130 datasheet <https://github.com/Tinkerforge/silent-stepper-v2-bricklet/raw/master/datasheets/TMC2130_datasheet.pdf>`__.
...
..
	A `laser-cut case for the Silent Stepper Bricklet 2.0
	<https://www.tinkerforge.com/en/shop/cases/case-silent-stepper-v2-bricklet.html>`__ is available.

	.. image:: /Images/Cases/bricklet_silent_stepper_v2_case_350.jpg
	   :scale: 100 %
	   :alt: Case for Silent Stepper Bricklet 2.0
	   :align: center
	...
	.. image:: /Images/Exploded/silent_stepper_v2_exploded_350.png
	   :scale: 100 %
	   :alt: Exploded assembly drawing for Silent Stepper Bricklet 2.0
	   :align: center
