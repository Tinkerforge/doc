...
.. raw:: html
	...
	Bricklets/bricklet_ssr_w_master_[100|600].jpg                   Solid State Relay Bricklet with Master Brick
	...
	Bricklets/bricklet_ssr_w_cover_[100|600].jpg                    Solid State Relay Bricklet with cover
	Bricklets/bricklet_ssr_w_heatsink_tilted_low_[?|?].jpg          Solid State Relay Bricklet with heatsink
	Bricklets/bricklet_ssr_w_heatsink_tilted_[?|?].jpg              Solid State Relay Bricklet with heatsink
	Bricklets/bricklet_solid_state_relay_brickv_[100|].jpg          Solid State Relay Bricklet in Brick Viewer
	Dimensions/solid_state_relay_bricklet_dimensions_[100|600].png  Outline and drilling plan

	{% tfgalleryend %}

.. note::

 The Solid State Relay Bricklet is discontinued. We are selling our remaining stock. The
...
* SSR AC 380V/25A (KS15/D-38Z25-L) datasheet (`Download <https://github.com/Tinkerforge/solid-state-relay-bricklet/raw/master/datasheets/ks15_ac.pdf>`__)
* SSR DC 50V/80A (KS33/D-50D80-L) datasheet (`Download <https://github.com/Tinkerforge/solid-state-relay-bricklet/raw/master/datasheets/ks33_dc.pdf>`__)
* SSR heatsink (HF92B-120) datasheet (`Download <https://github.com/Tinkerforge/solid-state-relay-bricklet/raw/master/datasheets/hf92b_heatsink.pdf>`__)
* SSR cover datasheet (`Download <https://github.com/Tinkerforge/solid-state-relay-bricklet/raw/master/datasheets/ssr_cover.pdf>`__)
