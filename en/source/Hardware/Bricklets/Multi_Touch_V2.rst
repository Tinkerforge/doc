...
* 3D model (`View online <https://autode.sk/31GkD8A>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/multi_touch_v2/multi-touch-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/multi_touch_v2/multi-touch-v2.FCStd>`__)
