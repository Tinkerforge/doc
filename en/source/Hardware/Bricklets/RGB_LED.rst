...
* 3D model (`View online <http://autode.sk/2xfTqL4>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/rgb_led/rgb-led.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/rgb_led/rgb-led.FCStd>`__)
