...
* 3D model (`View online <http://autode.sk/2BfnHz6>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/piezo_speaker/piezo_speaker.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/piezo_speaker/piezo_speaker.FCStd>`__)
