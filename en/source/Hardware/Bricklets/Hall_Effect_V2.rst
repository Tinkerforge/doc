...
* 3D model (`View online <https://autode.sk/2VBKu39>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/hall_effect_v2/hall-effect-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/hall_effect_v2/hall-effect-v2.FCStd>`__)
