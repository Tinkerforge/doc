...
* 3D model (`View online <https://autode.sk/2HQg0zb>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/real_time_clock_v2/real-time-clock-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/real_time_clock_v2/real-time-clock-v2.FCStd>`__)
