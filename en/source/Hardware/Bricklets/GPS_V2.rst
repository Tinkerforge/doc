...
* 3D model (`View online <http://autode.sk/2gCnY6M>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/gps_v2/gps.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/gps_v2/gps.FCStd>`__)
