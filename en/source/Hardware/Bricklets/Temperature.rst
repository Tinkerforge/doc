...
.. note::
 ...
 The Temperature Bricklet is discontinued. We are selling our remaining stock. The
 :ref:`Temperature Bricklet 2.0 <temperature_v2_bricklet>` is the recommended
 replacement.
...
* 3D model (`View online <https://autode.sk/2iSRJ0y>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/temperature/temperature.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/temperature/temperature.FCStd>`__)
