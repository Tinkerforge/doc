...
The RGB LED Button Bricklet has a 7 pole Bricklet connector and is connected to a
...
* 3D model (`View online <http://autode.sk/2BUxGXm>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/rgb_led_button/rgb-button-bricklet.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/rgb_led_button/rgb-button-bricklet.FCStd>`__)
