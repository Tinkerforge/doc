...
:shoplink: ../../../shop/bricklets/distance-ir-10-80cm-bricklet.html
...
--------------------------------  ------------------------------------------------------------------
--------------------------------  ------------------------------------------------------------------
Distance                          Depends on attached `Sharp <https://www.sharpsma.com>`__ IR Sensor:
...
* Schematic (`Download <https://github.com/Tinkerforge/distance-ir-bricklet/raw/master/hardware/distance-ir-schematic.pdf>`__)
...
* 3D model (`View online <https://autode.sk/2rIh6qT>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/distance_ir/distance-ir.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/distance_ir/distance-ir.FCStd>`__)
