...
* 3D model (`View online <https://autode.sk/2WFOtYT>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/segment_display_4x7_v2/segment-display-4x7-v2.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/segment_display_4x7_v2/segment-display-4x7-v2.FCStd>`__)
