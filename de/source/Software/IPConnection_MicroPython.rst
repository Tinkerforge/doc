...
.. |ref_install_guide| replace:: :ref:`Installationanleitung <api_bindings_micropython_install>`
...
* Error.TIMEOUT = -1
* Error.NOT_ADDED = -6 (seit Version 2.0.0 nicht mehr verwendet)
...
.. py:function:: IPConnection.authenticate(secret)
 ...
 .. note::
  Authentifizierung benötigt das ``hmac`` Modul, welches in den meisten
  MicroPython-Builds nicht enthalten ist. Es kann über MicroPythons
...
.. py:function:: IPConnection.dispatch_callbacks(seconds)
 ...
 Werte bedeuten unendlich). Da MicroPython keine Threads unterstützt muss diese
 Methode periodisch aufgerufen werden, um sicherzustellen, dass eingehende
 Callbacks behandelt werden. Falls keine Callbacks benutzt werden braucht diese
 Methode nicht aufgerufen zu werden.
