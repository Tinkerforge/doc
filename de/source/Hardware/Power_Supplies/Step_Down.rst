...
* 3D Modell (`Online ansehen <http://autode.sk/2BVUBBy>`__ | Download: `STEP <http://download.tinkerforge.com/3d/power_supplies/step_down/step-down.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/power_supplies/step_down/step-down.FCStd>`__)
