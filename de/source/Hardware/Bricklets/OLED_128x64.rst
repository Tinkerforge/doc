...
.. note::
 ...
 Das OLED 128x64 Bricklet ist abgekündigt. Wir verkaufen noch unseren restlichen Lagerbestand.
...
* 3D Modell (`Online ansehen <http://autode.sk/2BWH38V>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/oled_128x64/oled-128x64.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/oled_128x64/oled-128x64.FCStd>`__)
