...
* Schwarz/Weiß OLED
* Größe von 1,3" mit 128x64 Auflösung
...
Eine `Demo <https://github.com/Tinkerforge/oled-128x64-bricklet/blob/master/software/examples/python/example_draw_servo_poti.py>`__ zusammen mit einem Servo Brick und einem Rotary Poti Bricklet ist
...
(4 KByte) zur Verfügung. Dies ist ist nicht genug um zum Beispiel ein 
128x64 schwarz/weiß Bild zwischenzuspeichern. Daher können wir keine
konfortablen APIs wie ``drawLine(xy, xy)`` anbieten.

Um auf das OLED Display zu zeichnen empfehlen wir eine Image Libarary
...
* C# (mit TODO), 
* Java (mit TODO) und
* `Python <https://raw.githubusercontent.com/Tinkerforge/oled-128x64-bricklet/master/software/examples/python/example_draw_servo_poti.py>`__ (mit `PIL <https://python-pillow.github.io/>`__).
