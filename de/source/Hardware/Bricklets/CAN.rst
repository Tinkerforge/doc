...
* 3D Modell (`Online ansehen <http://autode.sk/2yCi7Wa>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/can/can.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/can/can.FCStd>`__)
