...
* 3D Modell (`Online ansehen <http://autode.sk/2BK1DJ4>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/remote_switch_v2/remote.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricklets/remote_switch_v2/remote.FCStd>`__)
