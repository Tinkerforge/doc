...
* 3D Modell (`Online ansehen <http://autode.sk/2BfXSyW>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/led_strip/led_strip.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/led_strip/led_strip.FCStd>`__)
