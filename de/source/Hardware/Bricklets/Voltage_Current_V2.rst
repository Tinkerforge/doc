...
* 3D Modell (`Online ansehen <https://autode.sk/2KdgYGx>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/voltage_current_v2/voltage-current-v2.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/voltage_current_v2/voltage-current-v2.FCStd>`__)
