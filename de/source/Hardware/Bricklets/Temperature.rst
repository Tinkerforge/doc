...
* 3D Modell (`Online ansehen <https://autode.sk/2iSRJ0y>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/temperature/temperature.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/temperature/temperature.FCStd>`__)
