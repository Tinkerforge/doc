...
* 3D Modell (`Online ansehen <https://autode.sk/2rAcbZ9>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/led_strip_v2/led-strip-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/led_strip_v2/led-strip-v2.FCStd>`__)
