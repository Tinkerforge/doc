...
* 3D Modell (`Online ansehen <http://autode.sk/2kpfpdx>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/color/color.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/color/color.FCStd>`__)
