...
* 3D Modell (`Online ansehen <https://autode.sk/2t6TFYR>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/motorized_linear_poti/motorized-linear-poti.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/motorized_linear_poti/motorized-linear-poti.FCStd>`__)
