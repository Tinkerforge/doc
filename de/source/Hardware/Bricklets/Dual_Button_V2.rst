...
* 3D Modell (`Online ansehen <https://autode.sk/2LOtykd>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/dual_button_v2/dual-button-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/dual_button_v2/dual-button-v2.FCStd>`__)
