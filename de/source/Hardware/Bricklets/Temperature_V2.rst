...
* 3D Modell (`Online ansehen <https://autode.sk/2v9CCqr>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/temperature_v2/temperature-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/temperature_v2/temperature-v2.FCStd>`__)
