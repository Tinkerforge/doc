...
.. note::
 ...
 Bis dahin werden als möglicher Ersatz das :ref:`Distance IR Bricklet 2.0 <distance_ir_v2_bricklet>`
 und das :ref:`Laser Range Finder Bricklet 2.0 <laser_range_finder_v2_bricklet>`
 empfohlen.
...
* 3D Modell (`Online ansehen <https://autode.sk/2Ie3TvY>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/distance_us/distance_us.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/distance_us/distance_us.FCStd>`__)
