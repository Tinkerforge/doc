...
* Unterstützt GPS und GLONASS gleichzeitig
...
* Schaltplan (`Download <https://github.com/Tinkerforge/gps-v2-bricklet/raw/master/hardware/gps-v2-schematic.pdf>`__)
...
* 3D Modell (`Online ansehen <https://autode.sk/2BgLPRK>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/gps_v2/gps-v2.1.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/gps_v2/gps-v2.1.FCStd>`__)
