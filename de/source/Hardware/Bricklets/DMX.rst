...
* 3D Modell (`Online ansehen <http://autode.sk/2yJPLu6>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/dmx/dmx.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/dmx/dmx.FCStd>`__)
