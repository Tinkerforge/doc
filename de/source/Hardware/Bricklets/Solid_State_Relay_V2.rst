...
..
	.. raw:: html
		...
		Bricklets/bricklet_ssr_v2_w_master_[100|600].jpg                   Solid State Relay Bricklet 2.0 mit Master Brick
		...
		Bricklets/bricklet_ssr_v2_w_cover_[100|600].jpg                    Solid State Relay Bricklet 2.0 mit Abdeckung
		Bricklets/bricklet_ssr_v2_w_heatsink_tilted_low_[?|?].jpg          Solid State Relay Bricklet 2.0 mit Kühlkörper
		Bricklets/bricklet_ssr_v2_w_heatsink_tilted_[?|?].jpg              Solid State Relay Bricklet 2.0 mit Kühlkörper
		Bricklets/bricklet_solid_state_relay_v2_brickv_[100|].jpg          Solid State Relay Bricklet 2.0 im Brick Viewer
		Dimensions/solid_state_relay_v2_bricklet_dimensions_[100|600].png  Umriss und Bohrplan
...
das über das Solid State Relay Bricklet 2.0 gesteuert wird.
...
* SSR AC 380V/25A (KS15/D-38Z25-L) Datenblatt (`Download <https://github.com/Tinkerforge/solid-state-relay-v2-bricklet/raw/master/datasheets/ks15_ac.pdf>`__)
* SSR DC 50V/80A (KS33/D-50D80-L) Datenblatt (`Download <https://github.com/Tinkerforge/solid-state-relay-v2-bricklet/raw/master/datasheets/ks33_dc.pdf>`__)
* SSR Kühlkörper (HF92B-120) Datenblatt (`Download <https://github.com/Tinkerforge/solid-state-relay-v2-bricklet/raw/master/datasheets/hf92b_heatsink.pdf>`__)
* SSR Abdeckung Datenblatt (`Download <https://github.com/Tinkerforge/solid-state-relay-v2-bricklet/raw/master/datasheets/ssr_cover.pdf>`__)
...
* 3D Modell (`Online ansehen <http://autode.sk/2nJnz25>`__ | Download: `STEP <http://download.tinkerforge.com/3d/solid_state_relay_v2/solid_state_relay.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/solid_state_relay_v2/solid_state_relay.FCStd>`__)
...
.. image:: /Images/Bricklets/bricklet_solid_state_relay_v2_brickv.jpg
   :scale: 100 %
   :alt: Solid State Relay Bricklet 2.0 im Brick Viewer
   :align: center
