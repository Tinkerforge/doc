...
.. raw:: html
	...
	Bricklets/bricklet_io16_master_[100|600].jpg       IO-16 Bricklet mit Master Brick
	Cases/bricklet_io16_case_[100|600].jpg             IO-16 Bricklet im Gehäuse
	Bricklets/bricklet_io16_brickv_[100|].jpg          IO-16 Bricklet im Brick Viewer
	Dimensions/io16_bricklet_dimensions_[100|600].png  Umriss und Bohrplan

	{% tfgalleryend %}

.. note::

 Das IO-16 Bricklet ist abgekündigt. Wir verkaufen noch unseren restlichen Lagerbestand.
 Als Ersatz wird das :ref:`IO-16 Bricklet 2.0 <io16_v2_bricklet>`
 empfohlen.
...
* Schaltplan (`Download <https://github.com/Tinkerforge/io16-bricklet/raw/master/hardware/io16-schematic.pdf>`__)
...
* 3D Modell (`Online ansehen <https://autode.sk/2BePBLK>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/io16/io16.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/io16/io16.FCStd>`__)
