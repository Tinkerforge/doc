...
.. note::
 ...
 Das Segment Display 4x7 Bricklet ist abgekündigt. Wir verkaufen noch unseren restlichen Lagerbestand.
 Als Ersatz wird das :ref:`Segment Display 4x7 Bricklet 2.0 <segment_display_4x7_v2_bricklet>`
 empfohlen.
...
* 3D Modell (`Online ansehen <https://autode.sk/2iV9qNf>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/segment_display_4x7/segment-display-4x7.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/segment_display_4x7/segment-display-4x7.FCStd>`__)
