...
* 3D Modell (`Online ansehen <http://autode.sk/2xgJDo0>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricklets/ambient_light_v2/ambient-light.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricklets/ambient_light_v2/ambient-light.FCStd>`__)
