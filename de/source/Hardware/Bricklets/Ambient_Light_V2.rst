...
.. note::
 ...
 Das Ambient Light Bricklet 2.0 ist abgekündigt und wird nicht mehr verkauft.
...
* 3D Modell (`Online ansehen <https://autode.sk/2BVGBaN>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/ambient_light_v2/ambient-light-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/ambient_light_v2/ambient-light-v2.FCStd>`__)
