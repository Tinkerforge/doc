...
* 3D Modell (`Online ansehen <https://autode.sk/2IeyZE6>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/load_cell_v2/load-cell-v2.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/load_cell_v2/load-cell-v2.FCStd>`__)
