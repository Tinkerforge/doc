...
* 3D Modell (`Online ansehen <https://autode.sk/2BcQdkS>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricklets/load_cell/load-cell.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricklets/load_cell/load-cell.FCStd>`__)
