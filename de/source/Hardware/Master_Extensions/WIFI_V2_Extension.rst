...
* 3D Modell (`Online ansehen <http://autode.sk/2xfpGhI>`__ | Download: `STEP <http://download.tinkerforge.com/3d/extensions/wifi_v2/wifi-extension.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/extensions/wifi_v2/wifi-extension.FCStd>`__)
