...
* 3D Modell (`Online ansehen <http://autode.sk/2BWTrp9>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/debug/debug.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricks/debug/debug.FCStd>`__)
