...
* 3D Modell (`Online ansehen <http://a360.co/2s9r82x>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/debug/debug.step>`__,  `FreeCAD <http://download.tinkerforge.com/3d/bricks/debug/debug.FCStd>`__)
