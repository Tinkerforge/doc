...
:breadcrumbs: <a href="../../index.html">Startseite</a> / <a href="../../index.html#hardware">Hardware</a> / Servo Brick
...
* Unterstützt `TurboPWM <https://wiki.openpilot.org/display/WIKI/Turbo+PWM>`__
...
* 3D Modell (`Online ansehen <http://autode.sk/2xf1bkz>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/servo/servo.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricks/servo/servo.FCStd>`__)
