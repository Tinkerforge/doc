...
* 3D Modell (`Online ansehen <http://autode.sk/2BWTiSD>`__ | Download: `STEP <http://download.tinkerforge.com/3d/bricks/dc/dc.step>`__, `FreeCAD <http://download.tinkerforge.com/3d/bricks/dc/dc.FCStd>`__)
