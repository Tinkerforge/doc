...
.. note::
 ...
 Als Ersatz wird das :ref:`DC Bricklet 2.0 <dc_v2_bricklet>` oder das
...
* 3D Modell (`Online ansehen <https://autode.sk/2BWTiSD>`__ | Download: `STEP <https://download.tinkerforge.com/3d/bricks/dc/dc.step>`__, `FreeCAD <https://download.tinkerforge.com/3d/bricks/dc/dc.FCStd>`__)
