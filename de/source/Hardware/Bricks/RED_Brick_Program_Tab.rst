...
* Bei JavaScript, Perl, PHP, Python und Ruby können die Skriptdateien
...
Die ``Tinkerforge.jar`` Java Bindings sind unter
...
* Mode *Cron*: Nutze `cron <https://de.wikipedia.org/wiki/Cron>`__ um die
  ...
  * oder jede Minute in der 12. Stunde des Montags, sofern dieser der 16. Tag
  ...
  aber über keine Uhr, die weiter läuft wenn der Brick heruntergefahren
...
Im letzten Schritt kann der **Start Upload** Button geklickt werden um die
