...
* :ref:`Demo-Anwendung <starter_kit_blinkenlights_demo_examples>` (Download: `Windows <https://download.tinkerforge.com/kits/blinkenlights/windows/starter_kit_blinkenlights_demo_windows_latest.exe>`__, `Linux <https://download.tinkerforge.com/kits/blinkenlights/linux/starter-kit-blinkenlights-demo-linux_latest.deb>`__, `macOS <https://download.tinkerforge.com/kits/blinkenlights/macos/starter_kit_blinkenlights_demo_macos_latest.dmg>`__, `Quelltext <https://github.com/Tinkerforge/blinkenlights/tree/master/demo>`__)
...
unserem `Forum <https://www.tinkerunity.org/>`__,
