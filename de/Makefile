...
html:
	...
	@echo
	@echo "Changing Source_Code.html from doc to downloads"
	sed -e "s|'doc'|'downloads'|" build/html/Downloads.html > build/html/Downloads.htmltmp
	mv build/html/Downloads.htmltmp build/html/Downloads.html
